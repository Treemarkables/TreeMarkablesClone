...
export function ServiceJobForm({
  ...
  return (
    <>
          ...
          <div className="bg-amber-500 text-white p-4 rounded-t-lg">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-4">
                ...
                <div className="text-amber-100">New Job Request</div>
              </div>
              <Button
                variant="ghost"
                size="icon"
              ...
              <Button
                ...
                onClick={() => {
                  toast({
                    title: "Call Feature",
                    description:
                      "Call functionality would integrate with phone system here.",
                  });
                }}
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          >
                            ...
                            <SelectContent>
                              <SelectItem value="tree_removal">
                                Tree Removal
                              </SelectItem>
                              <SelectItem value="tree_trimming">
                                Tree Trimming
                              </SelectItem>
                              <SelectItem value="stump_grinding">
                                Stump Grinding
                              </SelectItem>
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              <Input
                                ...
                                {...field}
                                data-testid="input-job-contact-first-name"
                              />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              <Input
                                ...
                                {...field}
                                data-testid="input-job-contact-last-name"
                              />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              <Input
                                ...
                                {...field}
                                data-testid="input-job-contact-email"
                              />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              <Input
                                ...
                                {...field}
                                data-testid="input-billing-contact-mobile"
                              />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
      ...
      <ProposalGeneration
        customerId={
          isCreatingNewCustomer ? undefined : form.watch("customerId")
        }
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                defaultValue={
                  form.watch("jobContactPhone") ||
                  form.watch("newCustomerPhone")
                }
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input type="date" data-testid="input-schedule-date" />
            </div>
            <div>
