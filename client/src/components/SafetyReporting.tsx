...
export function SafetyReporting({ compact = false }: SafetyReportingProps) {
  ...
  const [showNewRiskAssessmentDialog, setShowNewRiskAssessmentDialog] =
    useState(false);
  const [selectedRiskAssessment, setSelectedRiskAssessment] =
    useState<RiskAssessment | null>(null);
  const [showEditRiskAssessmentDialog, setShowEditRiskAssessmentDialog] =
    useState(false);
  ...
  const [showEditComplianceDialog, setShowEditComplianceDialog] =
    useState(false);
  const [activeTab, setActiveTab] = useState<
    "incidents" | "assessments" | "compliance"
  >("incidents");
  ...
  const updateIncidentMutation = useMutation({
    mutationFn: async ({
      ...
      id: string;
      data: Partial<SafetyIncidentFormData>;
    }) => {
  ...
  const updateRiskAssessmentMutation = useMutation({
    mutationFn: async ({
      ...
      id: string;
      data: Partial<RiskAssessmentFormData>;
    }) => {
  ...
  const updateComplianceMutation = useMutation({
    mutationFn: async ({
      ...
      id: string;
      data: Partial<ComplianceRequirementFormData>;
    }) => {
  ...
  const onSubmitEditRiskAssessment = (data: RiskAssessmentFormData) => {
    if (selectedRiskAssessment) {
      const submitData = { ...data, jobId: data.jobId || null };
      updateRiskAssessmentMutation.mutate({
        id: selectedRiskAssessment.id,
        data: submitData,
      });
    }
  };
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Badge
                variant={stats.open > 0 ? "destructive" : "secondary"}
            ...
            {stats.highSeverity > 0 && (
              <Alert className="border-red-200 bg-red-50">
                ...
                <AlertDescription className="text-sm">
                  {stats.highSeverity} high-severity incident
                  {stats.highSeverity > 1 ? "s" : ""} require attention
                </AlertDescription>
              </Alert>
            )}
              ...
              <div className="space-y-2">
                {recentIncidents.map((incident: SafetyIncident) => (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <Badge
                        className={`${getTypeColor(incident.type)} text-white text-xs`}
                      >
  ...
  return (
    <div className="space-y-4 sm:space-y-6 w-full max-w-full min-w-0 overflow-x-hidden">
      ...
      <Tabs
        value={activeTab}
        onValueChange={(value) =>
          setActiveTab(value as "incidents" | "assessments" | "compliance")
        }
      >
        ...
        <TabsContent value="incidents" className="space-y-4 sm:space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                <div
                  ...
                  data-testid="stat-high-severity"
                >
                  {stats.highSeverity}
                </div>
              </CardContent>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  ...
                  >
                    ...
                    <DialogContent
                      className="max-w-2xl"
                      aria-describedby="new-incident-description"
                    >
                      <DialogHeader>
                        <DialogTitle>Report Safety Incident</DialogTitle>
                      </DialogHeader>
                      <div id="new-incident-description" className="sr-only">
                        Create a new safety incident report with details about
                        the incident
                      </div>
                      <Form {...newIncidentForm}>
                        <form
                          onSubmit={newIncidentForm.handleSubmit(
                            onSubmitNewIncident,
                          )}
                          className="space-y-4"
                        >
          ...
          <Dialog open={showEditDialog} onOpenChange={setShowEditDialog}>
            <DialogContent
              className="max-w-2xl"
              aria-describedby="edit-incident-description"
            >
              <DialogHeader>
              ...
              {selectedIncident && (
                <Form {...editIncidentForm}>
                  <form
                    onSubmit={editIncidentForm.handleSubmit(
        ...
        <TabsContent value="assessments" className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <Dialog
              open={showNewRiskAssessmentDialog}
              onOpenChange={setShowNewRiskAssessmentDialog}
            >
              <DialogTrigger asChild>
              ...
              <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                ...
                <Form {...newRiskAssessmentForm}>
                  <form
                    onSubmit={newRiskAssessmentForm.handleSubmit(
                      onSubmitNewRiskAssessment,
                    )}
                    className="space-y-6"
                  >
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input
                                placeholder="Link to a job ID (optional)"
                                {...field}
                                value={field.value || ""}
                              />
                            </FormControl>
            ...
            <CardContent>
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 mb-4 sm:mb-6">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-600">
                    {
                      riskAssessments.filter((a: RiskAssessment) => a.isActive)
                        .length
                    }
                  </div>
              ...
              {isLoadingAssessments ? (
                ...
                <div className="text-center py-8 text-muted-foreground">
                  No risk assessments found. Create your first assessment to get
                  started.
                </div>
              ) : (
                <div className="space-y-4">
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <Badge
                            className={`${getSeverityColor(assessment.overallRisk)} text-white`}
                          >
                            {assessment.overallRisk.toUpperCase()}
                          </Badge>
                          <span className="font-medium">
                            {assessment.jobId
                              ? `Job: ${assessment.jobId.substring(0, 8)}...`
                        ...
                        <div className="flex items-center gap-2">
                          <Badge
                            variant={
                              assessment.isActive ? "default" : "secondary"
                            }
                          >
        ...
        <TabsContent value="compliance" className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <Dialog
              open={showNewComplianceDialog}
              onOpenChange={setShowNewComplianceDialog}
            >
              <DialogTrigger asChild>
              ...
              <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                ...
                <Form {...newComplianceForm}>
                  <form
                    onSubmit={newComplianceForm.handleSubmit(
                      onSubmitNewCompliance,
                    )}
                    className="space-y-6"
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              placeholder="e.g., OSHA, EPA, Local Authority"
                              {...field}
                            />
                          </FormControl>
                          <FormMessage />
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {complianceAnalytics.totalRequirements || 0}
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold text-red-600">
                  {complianceAnalytics.overdueRequirements || 0}
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold text-yellow-600">
                  {complianceAnalytics.upcomingRequirements || 0}
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold text-green-600">
                  {complianceAnalytics.averageComplianceScore || 0}%
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <Card>
            ...
            <CardContent>
              {isLoadingCompliance ? (
                ...
                <div className="text-center py-8 text-muted-foreground">
                  No compliance requirements found. Create your first
                    ...
                    (requirement: ComplianceRequirement) => (
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <Badge
                              className={`${getSeverityColor(requirement.priority)} text-white`}
                            >
