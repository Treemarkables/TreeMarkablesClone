      ...
      <section className="py-20 bg-background">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Professional equipment and experienced operators ensure efficient removal 
              with minimal impact on your landscape.
            </p>
          </div>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    Our powerful stump grinder reduces the entire stump and root system 
                    to wood chips, going well below ground level.
                  </p>
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="h-5 w-5 text-blue-600 dark:text-blue-400" />
                    <span className="text-sm font-medium text-foreground">
                      Ground to 300mm below surface
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    We guarantee complete stump removal and professional finish. 
                    Your satisfaction is our priority on every job.
                  </p>
                  <div className="flex items-center space-x-2">
