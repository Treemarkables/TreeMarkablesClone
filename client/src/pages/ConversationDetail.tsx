  ...
  return (
    <div className="flex flex-col absolute top-0 left-0 right-0 bottom-20 bg-white dark:bg-gray-950 w-full overflow-hidden">
      ...
      <div className="flex items-start justify-between px-3 sm:px-4 py-3 sm:py-4 border-b bg-white dark:bg-gray-950 flex-shrink-0 w-full gap-3">
        <div className="flex items-start gap-2 sm:gap-3 flex-1 min-w-0 overflow-hidden pr-3">
          <Button 
            variant="ghost" 
            size="icon"
          ...
          <div className="flex-1 min-w-0 overflow-hidden pr-2">
            <h1 className="font-bold text-base sm:text-lg text-gray-900 dark:text-gray-100 break-words leading-snug pr-2" data-testid="text-conversation-title">
              {conversation.title}
            </h1>
          ...
          {messages.length === 0 ? (
            ...
            messages.map((message: ConversationMessage) => {
              ...
              return (
                ...
                >
                  <div
                    className={`max-w-[82%] sm:max-w-[75%] rounded-lg px-3 py-2 ${
