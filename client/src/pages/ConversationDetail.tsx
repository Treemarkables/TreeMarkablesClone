  ...
  return (
    <div className="flex flex-col absolute top-0 left-0 right-0 bottom-20 bg-white dark:bg-gray-950 w-full overflow-hidden">
      ...
      <div className="flex items-start justify-between px-3 sm:px-4 py-3 sm:py-4 border-b bg-white dark:bg-gray-950 flex-shrink-0 w-full gap-4">
        <div className="flex items-start gap-2 sm:gap-3 flex-1 min-w-0 overflow-hidden pr-8">
          <Button 
            variant="ghost" 
            size="icon"
          ...
          <div className="flex-1 min-w-0 overflow-hidden pr-6">
            <h1 className="font-bold text-base sm:text-lg text-gray-900 dark:text-gray-100 break-words leading-snug pr-6" data-testid="text-conversation-title">
              {conversation.title}
            </h1>
            <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 capitalize mt-0.5 pr-2">
              {conversation.source}
            </p>
          </div>
        </div>
          ...
          {messages.length === 0 ? (
            ...
            messages.map((message: ConversationMessage) => {
              ...
              return (
                ...
                >
                  <div
                    className={`max-w-[65%] sm:max-w-[75%] rounded-lg px-3 py-2 ${
