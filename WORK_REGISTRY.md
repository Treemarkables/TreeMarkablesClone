...
## Active
- staff-schedule multi-week views — branch `feat/staff-schedule-multiweek` — 2026-06-12 — 1/2/3/4-week view toggle on /staff-schedule: no-scroll availability grid (staff × days heatmap, unassigned lane, per-day revenue footer), new `/api/jobs/for-date-range` endpoint, drill-to-day; Day Gantt unchanged [PR #176]
