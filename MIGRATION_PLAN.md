...
- **Phase 2 — soak window started (2026-05-11):**
  ...
  - **Soak posture:** customers stay on `app.treemarkables.co.nz` (Replit). Internal team uses `do.app.treemarkables.co.nz`. `RUN_CRONS=false` on DO; Replit keeps cron + webhook leadership.
