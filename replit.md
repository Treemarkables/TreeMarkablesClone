...
## Recent Changes
### October 18, 2025
- **Lead Source Analytics Simplification - COMPLETE**: Simplified Lead Source Performance table to focus on quoted job conversion. Removed "Total Leads" column and consolidated metrics to show only: Lead Source, Quoted, Won, Quote Conv. (Won÷Quoted%), and Total Revenue. This provides clearer insight into how well quoted jobs convert to revenue without the complexity of total lead tracking.
