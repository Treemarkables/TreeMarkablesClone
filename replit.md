...
- **Invoice Email Placeholder Fix**: Fixed email template placeholder replacement to show actual invoice data (invoice number, amount, address, due date) instead of {placeholders}. Uses global regex replacement to handle all instances.
