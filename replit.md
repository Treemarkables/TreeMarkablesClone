...
- **Integrations**: Twilio Voice (auto call recording, job creation & quote generation), OpenAI (Whisper transcription & GPT-5 extraction), Email-to-Job-Diary, Mobile App Integration, Xero Accounting Integration, Addy.co.nz Address Autocomplete, SendGrid (email tracking), SMS Everyone NZ.
